...
-- Classe 1 - Capitaux
('108', 'Compte de l’exploitant', 1, 'passif'),
('120', 'Résultat de l''exercice', 1, 'passif'),

-- Classe 2 - Immobilisations
('203', 'Logiciel', 2, 'actif'),
('203100', 'Licences logicielles', 2, 'actif'),
('2183', 'Matériel informatique', 2, 'actif'),
('212818384', 'Amort. matériel informatique', 2, 'actif'),
...
-- Classe 5 - Trésorerie
('512', 'Banque', 4, 'actif'),
('512100', 'Banque pro', 4, 'actif'),

-- Classe 6 - Charges
('6063', 'Petit matériel informatique', 6, 'charge'),
('611', 'Sous-traitance générale', 6, 'charge'),
('613', 'Locations', 6, 'charge'),
('613200', 'Quote-part loyer domicile', 6, 'charge'),
('615', 'Entretien et réparations', 6, 'charge'),
('616', 'Assurances', 6, 'charge'),
('618', 'Documentation / formation', 6, 'charge'),
('626', 'Télécoms / Internet', 6, 'charge'),
('626100', 'Internet', 6, 'charge'),
('627', 'Services bancaires', 6, 'charge'),
('635', 'Taxes CFE', 6, 'charge'),
